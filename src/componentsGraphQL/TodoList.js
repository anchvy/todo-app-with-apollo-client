...
export const SET_SELECTED_TODO_ITEMS_QUERY_NAME = 'selectedTodoItemsMutation'
...
const SET_SELECTED_TODO_ITEMS = gql`
  query SetSelectedTodoItems($id: String!) {
...
const DELETE_TODO_ITEMS = gql`
  mutation DeleteTodoItems($id: [String!]!) {
    deleteMultipleTodo(ids: $id) @client {
      ${TODO_LIST_DEFAULT_QUERY}
    }
  }
`
const DONE_TODO_ITEMS = gql`
  mutation DoneTodoItems($id: [String!]!) {
    doneMultipleTodo(ids: $id) @client {
      ${TODO_LIST_DEFAULT_QUERY}
    }
  }
`
...
export const composedSetSelectedTodoItemsQuery = graphql(SET_SELECTED_TODO_ITEMS, {
  name: SET_SELECTED_TODO_ITEMS_QUERY_NAME,
})
